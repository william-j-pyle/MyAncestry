Public Class StatusStripRenderer
    ...
    Private COLOR_BG As Color = My.Application.Config.Theme.BackColor(ThemeItemType.MENUBAR, ThemeColorItemState.ACTIVE)
    Private COLOR_FG As Color = My.Application.Config.Theme.ForeColor(ThemeItemType.MENUBAR, ThemeColorItemState.ACTIVE)
    Private COLOR_FG_DISABLED As Color = My.Application.Config.Theme.ForeColor(ThemeItemType.MENUBAR, ThemeColorItemState.DISABLED)

    Private COLOR_HOVER_BG As Color = My.Application.Config.Theme.BackColor(ThemeItemType.MENUBAR, ThemeColorItemState.HOVER)
    Private COLOR_HOVER_FG As Color = My.Application.Config.Theme.ForeColor(ThemeItemType.MENUBAR, ThemeColorItemState.HOVER)
    Private COLOR_HOVER_BORDER As Color = My.Application.Config.Theme.BorderColor(ThemeItemType.MENUBAR, ThemeColorItemState.HOVER)

    Private COLOR_SELECTED_BG As Color = My.Application.Config.Theme.BackColor(ThemeItemType.MENUBAR, ThemeColorItemState.SELECTED)
    Private COLOR_SELECTED_FG As Color = My.Application.Config.Theme.ForeColor(ThemeItemType.MENUBAR, ThemeColorItemState.SELECTED)
    Private COLOR_SELECTED_BORDER As Color = My.Application.Config.Theme.BorderColor(ThemeItemType.MENUBAR, ThemeColorItemState.SELECTED)
